// COPY of contrib/market/clientip.mjs -- that file is canonical; keep the two identical.
// (ops-dashboard deploys as a single directory, so it cannot import across contrib/.)
// ═══════════════════════════════════════════════════════════════════════════
