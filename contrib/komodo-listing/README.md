...
resulting txids go in `swaps/PCN-KMD.md`. KMD is the counterparty in 120 of the
136 existing files.
...
```sh
/opt/kdf/rpc maker '{"method":"setprice","base":"PCN","rel":"KMD","price":"2","volume":"100"}'
/opt/kdf/rpc taker '{"method":"buy","base":"PCN","rel":"KMD","price":"2.1","volume":"100"}'
...
`files/swaps/PCN-KMD.md` in that order.
...
files/swaps/PCN-KMD.md     -> swaps/PCN-KMD.md
```
