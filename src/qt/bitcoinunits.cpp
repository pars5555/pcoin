...
{
    switch (unit) {
    case Unit::BTC: return QString("PCN");
    case Unit::mBTC: return QString("mPCN");
    case Unit::uBTC: return QString::fromUtf8("µPCN (bits)");
...
{
    switch (unit) {
    case Unit::BTC: return QString("PCoins");
    case Unit::mBTC: return QString("Milli-PCoins (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-PCoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
